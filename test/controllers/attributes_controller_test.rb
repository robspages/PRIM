...
class AttributesControllerTest < ActionController::TestCase
  ...
  test "should create attribute" do
    assert_difference('Attribute.count') do
      post :create, attribute: { attributeType_id: @attribute.attributeType_id, isLocalizable: @attribute.isLocalizable, name: @attribute.name }
    end
  ...
  test "should update attribute" do
    patch :update, id: @attribute, attribute: { attributeType_id: @attribute.attributeType_id, isLocalizable: @attribute.isLocalizable, name: @attribute.name }
    assert_redirected_to attribute_path(assigns(:attribute))
  end
